...
public class ViewStudent extends javax.swing.JFrame {
    ...
    public ViewStudent() {
        ...
        try {
                ...
                while(rs.next()!=false)
                {
                    ...
                    String tfee=rs.getString("fee");
                    String tpaid=rs.getString("paid");
                    ...
                    String tcountry=rs.getString("country");
                    String tcontactno=rs.getString("contactno");
                    
                   String q[]={tname,troll,temail,tcourse,tfee,tpaid,tdue,taddress,tcity,tstate,tcountry,tcontactno};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Roll No", "Email", "Course", "Fee", "Paid", "Due", "Address", "City", "State", "Country", "Contact No"
            }
        ));
